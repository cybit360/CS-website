    ...
    <>
      ...
      <section className="bg-white py-16 lg:py-24">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <h2 className="text-2xl font-bold text-navy mt-12 mb-4">Information We Collect</h2>
          ...
          <h2 className="text-2xl font-bold text-navy mt-12 mb-4">How We Use Your Information</h2>
          <p className="text-steel mb-4 leading-relaxed">
          ...
          <h2 className="text-2xl font-bold text-navy mt-12 mb-4">Information Sharing</h2>
          <p className="text-steel mb-4 leading-relaxed">
          ...
          <h2 className="text-2xl font-bold text-navy mt-12 mb-4">Data Security</h2>
          <p className="text-steel mb-4 leading-relaxed">
          ...
          <h2 className="text-2xl font-bold text-navy mt-12 mb-4">Your Rights</h2>
          <p className="text-steel mb-4 leading-relaxed">
          ...
          <h2 className="text-2xl font-bold text-navy mt-12 mb-4">Cookies &amp; Tracking</h2>
          <p className="text-steel mb-4 leading-relaxed">
            ...
            our{" "}
            <Link href="/legal/cookies" className="text-accent-cyan hover:text-accent-cyan/80 underline">
              Cookie Policy
            </Link>.
          </p>

          <h2 className="text-2xl font-bold text-navy mt-12 mb-4">Children&apos;s Privacy</h2>
          <p className="text-steel mb-4 leading-relaxed">
