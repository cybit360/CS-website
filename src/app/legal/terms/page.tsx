    ...
    <>
      ...
      <section className="relative bg-navy overflow-hidden">
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-24 lg:py-32 relative z-10 text-center">
          <Breadcrumb variant="dark" items={[{ label: "Legal" }, { label: "Terms of Service" }]} />
      ...
      <section className="bg-white py-16 lg:py-24">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <h2 className="text-2xl font-bold text-navy mt-12 mb-4">Acceptance of Terms</h2>
          ...
          <h2 className="text-2xl font-bold text-navy mt-12 mb-4">Use License</h2>
          <p className="text-steel mb-4 leading-relaxed">
          ...
          <h2 className="text-2xl font-bold text-navy mt-12 mb-4">User Conduct</h2>
          <p className="text-steel mb-4 leading-relaxed">
          ...
          <h2 className="text-2xl font-bold text-navy mt-12 mb-4">Intellectual Property</h2>
          <p className="text-steel mb-4 leading-relaxed">
          ...
          <h2 className="text-2xl font-bold text-navy mt-12 mb-4">Disclaimers</h2>
          <p className="text-steel mb-4 leading-relaxed">
          ...
          <h2 className="text-2xl font-bold text-navy mt-12 mb-4">Limitation of Liability</h2>
          <p className="text-steel mb-4 leading-relaxed">
          ...
          <h2 className="text-2xl font-bold text-navy mt-12 mb-4">Indemnification</h2>
          <p className="text-steel mb-4 leading-relaxed">
          ...
          <h2 className="text-2xl font-bold text-navy mt-12 mb-4">Governing Law</h2>
          <p className="text-steel mb-4 leading-relaxed">
          ...
          <h2 className="text-2xl font-bold text-navy mt-12 mb-4">Changes to Terms</h2>
          <p className="text-steel mb-4 leading-relaxed">
